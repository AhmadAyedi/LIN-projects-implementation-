        ...
        while True:
            ...
            if current_size > last_size:
                with open(filename, 'r') as f:
                    ...
                    # Parse only if it's a light status line
                    if last_line.startswith("Light:") and "Result:" in last_line:
                        try:
                            ...
                            if light in LIGHT_IDS and status in STATUS_CODES:
                                ...
                                print(f"Ignoring unknown light/status: {last_line}")
                        except IndexError:
                            print(f"Malformed line: {last_line}")
